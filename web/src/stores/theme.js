...
const THEMES = {
  ...
  midnight: {
    ...
    success: '#4caf7d', danger: '#ef5350', warning: '#ffb74d', info: '#64b5f6'
  }
}
...
export const useThemeStore = defineStore('theme', () => {
  const themeName = ref(localStorage.getItem('wb_theme') || 'discord')
  ...
  return { themeName, theme, setTheme, naiveOverrides, THEMES }
})
